...
#
# $Id: ja.pm 107526 2009-07-23 18:23:52Z fyoshimatsu $
...
## addons/Community.pack/lib/MT/Community/CMS.pm
	...
	'Following' => '注目',
	'Followers' => '被注目',
	'Welcome to the Movable Type Community Solution' => 'コミュニティソリューションの新機能',
	'The Community Solution gives you to the tools to build a successful community with active, engaged conversations. Some key features to explore:' => 'Community Solutionには、活気にあふれたオンラインコミュニティを運営するために求められる様々な機能が含まれています。',
	'Friends and Followers' => '他のユーザーに注目',
	'Allow registered members to maintain a list of friends across your community' => '登録ユーザーはコミュニティの他のメンバーに注目する(友達として登録する)ことができます。',
...
## addons/Community.pack/templates/blog/entry_form.mtml
	'In order to create an entry on this blog you must first register.' => 'ブログに投稿する前に登録を行ってください。',
...
## addons/Community.pack/tmpl/cfg_community_prefs.tmpl
	...
	'Allow anonymous user to recommend' => '匿名での投票を許可',
